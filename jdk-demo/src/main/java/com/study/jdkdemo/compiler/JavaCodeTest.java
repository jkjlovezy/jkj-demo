...
public class JavaCodeTest {
    ...
    static String getSimpleCode() {
        StringBuilder code = new StringBuilder();
        code.append("package com.study.jdkdemo.compiler;");
    ...
    static String getSimpleCodeWithoutPackage(){
        StringBuilder code = new StringBuilder();
    ...
    static String getSimpleCodeWithSyntax(){
        StringBuilder code = new StringBuilder();
    ...
    static String getSimpleCodeWithSyntax0(){
        StringBuilder code = new StringBuilder();
        code.append("package org.apache.dubbo.common.compiler.support;");
    ...
    static String getSimpleCodeWithImports() {
        StringBuilder code = new StringBuilder();
        code.append("package org.apache.dubbo.common.compiler.support;");
    ...
    static String getSimpleCodeWithWithExtends() {
        StringBuilder code = new StringBuilder();
        code.append("package org.apache.dubbo.common.compiler.support;");
